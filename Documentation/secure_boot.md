...
1. **Download CST:** Manually download the latest version **(4.0.1)** of the CST from the [NXP CST Download Page](https://www.nxp.com/search?keyword=cst%2520tools&start=0)
2. **Extract:**
```
